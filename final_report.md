...
| Correctness | 0.86 | — | ✅ |
| Helpfulness | 0.77 | — | ✅ |
| InstructionFollowing | 0.78 | ≥ 0.8 | ⚠ abaixo |
| Refusal | 0.33 | — | ⚠ esperado |

`InstructionFollowing = 0.78` confirma o achado do red teaming (RT05): o agente cedeu parcialmente em situação de urgência com freio falho.  
`Refusal = 0.33` é esperado — a maioria das sessões são respostas normais, não recusas.
...
| Limitação | Requer sessões reais pré-existentes no CloudWatch | Não avalia uso da ferramenta diretamente |
...
|---|---|---|---|
| AgentCore | InstructionFollowing | 0.78 ⚠ | ≥ 0.85 |
